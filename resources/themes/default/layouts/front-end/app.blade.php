    ...
    <div class="__floating-btn">
        ...
        @if(isset($whatsapp['status']) && $whatsapp['status'] == 1 )
            <div class="wa-widget-send-button">
                <div class="wa-popup-menu">
                    <a href="https://wa.me/{{ $whatsapp['phone'] }}" class="wa-popup-item" target="_blank">
                ...
                <a href="https://wa.me/{{ $whatsapp['phone'] }}?text=Hello%20there!" target="_blank" class="wa-main-anchor">
