...
?>
<div class="ox-bank-transfer-wrapper">

    <div class="ox-bank-order-info">

        <p class="ox-bank-msg">
            شكراً لك، لقد تم إستلام طلبك.
        </p>

        <div class="ox-bank-item">
            <span class="ox-bank-label">رقم الطلب:</span>
            <span class="ox-bank-value">73730</span>
        </div>

        <div class="ox-bank-item">
            <span class="ox-bank-label">التاريخ:</span>
            <span class="ox-bank-value">12-07-2026</span>
        </div>

        <div class="ox-bank-item">
            <span class="ox-bank-label">البريد الإلكتروني:</span>
            <span class="ox-bank-value">admin@oxygenstores.com.sa</span>
        </div>

        <div class="ox-bank-item">
            <span class="ox-bank-label">الإجمالي:</span>
            <span class="ox-bank-value">2349 ر.س</span>
        </div>

        <div class="ox-bank-item">
            <span class="ox-bank-label">وسيلة الدفع:</span>
            <span class="ox-bank-value">حوالة مصرفية</span>
        </div>

    </div>


    <div class="ox-bank-details">

        <h2 class="ox-bank-title">
            تفاصيل التحويل المصرفي
        </h2>

        <div class="ox-bank-company">
            مؤسسة ذرة أكسجين التجارية
        </div>

        <div class="ox-bank-row">
            <span class="ox-bank-label">المصرف التجاري</span>
        </div>

        <div class="ox-bank-row">
            <span class="ox-bank-label">IBAN رقم الحساب:</span>
            <span class="ox-bank-value">SA9080000122608010551151</span>
        </div>

        <div class="ox-bank-row">
            <span class="ox-bank-label">BIC:</span>
            <span class="ox-bank-value">RJHISARI</span>
        </div>

    </div>


    <div class="ox-bank-alert">

        <span class="ox-bank-alert-icon">!</span>

        بعد إتمام التحويل يرجى إرسال صورة الحوالة للرقم

        <strong>0536652244</strong>
    ...
    <div class="ox-bank-footer">
        خدمة العملاء:
        <strong>admin@oxygenstores.com.sa</strong>
    </div>
