...
return [
	...
	"المحافظة" => "المحافظة",
	"الهاتف" => "الهاتف",
	"إسم_المنتج" => "إسم المنتج",
	"الكمية" => "الكمية",
	"Price_Excl_TAX" => "Price Excl TAX",
	"السعر_بدون_ضريبة" => "السعر بدون ضريبة",
	"TAX_Rate" => "TAX Rate",
	"نسبة_الضريبة" => "نسبة الضريبة",
	"TAX_Price" => "TAX Price",
	"سعر_الضريبة" => "سعر الضريبة",
	"Price_Incl_TAX" => "Price Incl TAX",
	"السعر_شامل_الضريبة" => "السعر شامل الضريبة",
	"رمز_المنتج" => "رمز المنتج",
	"Shipping" => "Shipping",
	"Payment_method" => "Payment method",
	"يتضمن" => "يتضمن",
	"ضريبة_القيمة_المضافة" => "ضريبة القيمة المضافة",
