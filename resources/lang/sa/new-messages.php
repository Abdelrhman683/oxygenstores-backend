...
return [
	...
	"Out_of_Stock" => "Out of Stock",
	"Manage_Branch_Stock" => "Manage Branch Stock",
	"Recent_Created" => "Recent Created",
	"Show_Older_First" => "Show Older First",
	"Most_Popular_Products" => "Most Popular Products",
	"Physical" => "Physical",
	"Clear_Filter" => "Clear Filter",
	"Failed_to_load_branch_stock_data" => "Failed to load branch stock data",
	...
	"add_new_method" => "Add new method",
	"want_to_turn_ON_tamara_as_the_Digital_Payment_method" => "Want to turn ON tamara as the Digital Payment method",
	"want_to_turn_ON_tabby_as_the_Digital_Payment_method" => "Want to turn ON tabby as the Digital Payment method",
	"tamara" => "Tamara",
	"api_token" => "Api token",
	"notification_token" => "Notification token",
	"tabby" => "Tabby",
	"merchant_code" => "Merchant code",
	"ex:الدولار_الأمريكي" => "Ex:الدولار الأمريكي",
	...
	"Sending..." => "Sending...",
	"OTP_code_sent_successfully_to" => "OTP code sent successfully to",
	"Verify_Phone_via_OTP_/_Login" => "Verify Phone via OTP / Login",
	"Something_went_wrong,_please_try_again" => "Something went wrong, please try again",
	"Please_enter_OTP_code" => "Please enter OTP code",
	"Verifying..." => "Verifying...",
	"Verify_&_Login" => "Verify & Login",
	"Pay_offline" => "Pay offline",
	"Go_Back" => "Go Back",
	...
	"Payment_info" => "Payment info",
	"Payment_method" => "Payment method",
	"Choos_Payment_Method" => "Choos Payment Method",
	"preparing_for_shipment" => "Preparing for shipment",
	"order_returned" => "Order returned",
	"order_failed" => "Order failed",
	"order_canceled" => "Order canceled",
	"تم_تقديم_الطلب" => "تم تقديم الطلب",
	"check" => "Check",
	"تم_تأكيد_الطلب" => "تم تأكيد الطلب",
	"Preparing_for_shipment" => "Preparing for shipment",
	"الطلب_في_طريقه" => "الطلب في طريقه",
	"تم_توصيل_الطلب" => "تم توصيل الطلب",
	"__________" => "          ",
	"مصرفي" => "مصرفي",
	"incomplete_info" => "Incomplete info",
	"استخدم_كود" => "استخدم كود",
	"Enter_OTP" => "Enter OTP",
	...
	"Custom_Date_Filter_By" => "Custom Date Filter By",
	"By_Month_And_Year" => "By Month And Year",
	"By_Year" => "By Year",
	"January" => "January",
	"February" => "February",
	"March" => "March",
